...
__all__ = [
    ...
    "Document",
    "DocumentDocument",
    "DocumentDocumentInvoice",
    "DocumentDocumentInvoiceChild",
    "DocumentChunk",
]

DocumentDocumentInvoiceChild: TypeAlias = Annotated[
    Union[
        Blob,
        "Callout",
        "Chunk",
...
class DocumentDocumentInvoice(BaseModel):
    ...
    children: Optional[TypingList[DocumentDocumentInvoiceChild]] = None
...
class Document(BaseModel):
    ...
    chunks: Optional[TypingList[DocumentChunk]] = None
...
class LiveGetResourceResponse(BaseModel):
    """A fetch/search result: the live documents plus what happened to them."""

    documents: TypingList[Document]

    indexed: Optional[bool] = None

    notes: Optional[TypingList[str]] = None
