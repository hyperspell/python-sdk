...
from hyperspell.pagination import SyncEntityCursorPage, AsyncEntityCursorPage
...
class TestEntities:
    ...
    def test_method_list(self, client: Hyperspell) -> None:
        ...
        assert_matches_type(SyncEntityCursorPage[EntityListResponse], entity, path=["response"])
...
class TestAsyncEntities:
    ...
    async def test_method_list(self, async_client: AsyncHyperspell) -> None:
        ...
        assert_matches_type(AsyncEntityCursorPage[EntityListResponse], entity, path=["response"])
