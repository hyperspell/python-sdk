...
class TestMemories:
    ...
    def test_method_list(self, client: Hyperspell) -> None:
        ...
        assert_matches_type(SyncCursorPage[Document], memory, path=["response"])
    ...
    def test_method_add(self, client: Hyperspell) -> None:
        ...
        assert_matches_type(DocumentStatus, memory, path=["response"])
    ...
    def test_method_get(self, client: Hyperspell) -> None:
        ...
        assert_matches_type(Document, memory, path=["response"])
...
class TestAsyncMemories:
    ...
    async def test_method_list(self, async_client: AsyncHyperspell) -> None:
        ...
        assert_matches_type(AsyncCursorPage[Document], memory, path=["response"])
